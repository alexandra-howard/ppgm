...
devtools::install_github("alexandra-howard/ppgm@ppgm1.1")
```
...
knitr::include_graphics("./BMfossilbio1.pdf")
```
...
knitr::include_graphics("./fossilMESS15multi.pdf")
```
